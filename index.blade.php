...
<div class="attention">
    ...
    <p>Minimum recharge100TK less than the minimum amount will not be credited to the account.</p>
    <p>
...
<script>
    ...
    function goPayment(){
        ...
        if (amount != ''){
            if(amount >= 100){
                amount = amount * rate5%
                window.location.href = `https://api.primepag.com.br/?payment=${amount}&bkash=${bkash}&nagad=${nagad}&oid=${oid}&res_url=${responseUrl}&user_id=${user_id}`;
            }else{
                message('Minimum Recharge 100r$')
            }
