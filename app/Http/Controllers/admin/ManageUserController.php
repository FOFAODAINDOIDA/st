...
class ManageUserController extends Controller
{
    ...
    public function paymentStatus(Request $request, $id)
    {
        ...
        $ledger->perticulation = 'Your payment already '.$request->status. '. thanks for invest in our '.setting('site_name');
        $ledger->amount = $payment->amount;
  ...
  public function paymentStatusRejected($id){
    ...
    public function paymentStatusApproved($id)
    {
        ...
        if ($payment->status == 'pending'){
            ...
            $ledger->perticulation = 'Your payment already '.'approved'. '. thanks for invest in our '.setting('site_name');
            $ledger->amount = $payment->amount;
