...
<head>
    ...
    <style>
        ...
        [data-v-81dae98a] .buybox .accounti .btnsit,
        [data-v-81dae98a] .buybox .invseti {
            height: 10.666667vw;
            background: #1989fa;
...
<body class="">
    ...
    <div id="app" data-v-app="">        
            ...
            <div class="homepage" data-v-81dae98a="">
                <div class="van-nav-bar van-hairline--bottom transparent" data-v-81dae98a="">
                    <div class="van-nav-bar__content"><!---->
                        ...
                        <div onclick='window.location.href="https://t.me/ponziscriptshop"'
                            class="van-nav-bar__right van-haptics-feedback"><img
                ...
                <section class="section-box" data-v-81dae98a="">
                    ...
                    <div class="needbox" data-v-81dae98a="">
                        <div class="choosei" data-v-81dae98a="">
                            <p data-v-81dae98a="">Common menu</p><span data-v-81dae98a="">Choose the menu you
                                need</span>
                        </div>
                        <div class="luckyuis" data-v-81dae98a=""
                            onclick="window.location.href='{{ route('user.drow') }}'">
                            <img src="https://img.icons8.com/emoji/48/coin-emoji.png" alt="" data-v-81dae98a="">
                            <div class="drawui" data-v-81dae98a="">
                                <p data-v-81dae98a="">Lucky</p>
                                <p data-v-81dae98a="">draw</p>
                            </div>
                        </div>
                    </div>
                    <div class="itemlist" data-v-81dae98a="" style="justify-content: space-between">
                        <div class="positui" data-v-81dae98a=""
                            onclick='window.location.href="https://t.me/ponziscriptshop"'><img
                        ...
                        <div class="positui" data-v-81dae98a=""
                            onclick="window.location.href='{{ route('invite.task') }}'"><img
                                ...
                                style="border-radius: 50px;filter: invert(1);" alt="" data-v-81dae98a="">
                            <p data-v-81dae98a="">Invite Task</p>
                        </div>

                        <div class="positui" data-v-81dae98a=""
                            onclick="window.location.href='{{ route('recharge') }}'"><img
                                src="{{ asset('public') }}/r.png" style="border-radius: 50px;background: #0012ff;"
                                alt="" data-v-81dae98a="">
                            <p data-v-81dae98a="">Recharge</p>
                        </div>


                        <div class="positui" data-v-81dae98a="" onclick="window.location.href='{{ route('income') }}'">
                            <img src="{{ asset('public') }}/task.jpg" style="border-radius: 50px;background: #0012ff;"
                                alt="" data-v-81dae98a="">
                            <p data-v-81dae98a="">Daily Task</p>
                        </div>

                    </div>
                    <div class="needbox" data-v-81dae98a="">
                        <div class="choosei" data-v-81dae98a="">
                            <p data-v-81dae98a="">Service List</p><span data-v-81dae98a="">Choose the service investment
                                you need</span>
                        </div>
                    </div>
                    <div class="prolist" data-v-81dae98a="">
                        @foreach (\App\Models\Package::where('status', 'active')->get() as $element)
                            <?php
                            $myPackage = \App\Models\Purchase::where('user_id', auth()->id())
                                ->where('package_id', $element->id)
                                ->where('status', 'active')
                                ->first();
                            $task = \App\Models\Task::first();
                            ?>
                            <div class="listi" data-v-81dae98a=""><img src="{{ asset($element->photo) }}"
                                    class="imgpro" alt="" data-v-81dae98a="">
                                <div class="double" data-v-81dae98a="">
                                    <p class="ellipsis-2" data-v-81dae98a="">{{ $element->name }}</p>
                                </div>
                                ...
                                <div class="infobox flex" data-v-81dae98a=""><span data-v-81dae98a="">Cycle:</span>
                                    <p data-v-81dae98a="">{{ $element->validity }} days</p>
                                </div>
                                <div class="infobox flex" data-v-81dae98a=""><span data-v-81dae98a="">Task
                                        Limit:</span>
                                    <p data-v-81dae98a="">{{ $element->task }}</p>
                                </div>
                                <div class="infobox flex" data-v-81dae98a=""><span data-v-81dae98a="">Daily
                                        income:</span>
                                    <p data-v-81dae98a="">{{ price($task->amount * $element->task) }}</p>
                                </div>
                                <div class="infobox flex" data-v-81dae98a=""><span data-v-81dae98a="">Total
                                        income:</span>
                                    <p data-v-81dae98a="">
                                        {{ price($task->amount * $element->task * $element->validity) }}</p>
                                </div>
                                @if ($myPackage)
                                    <button type="button" style="background: #1989fa;color: #fff;"
                                        class="van-button van-button--default van-button--normal nowbtn"
                                        data-v-81dae98a="">
                                        <div class="van-button__content"><!----><span
                                                class="van-button__text">Invested</span>
                                            <!---->
                                        </div>
                                    </button>
                                @else
                                    <button type="button"
                                        onclick="openModal('shvcdgvcg{{ $element->id }}', 'buy{{ $element->id }}')"
                                        class="van-button van-button--default van-button--normal nowbtn"
                                        data-v-81dae98a="">
                            ...
                            <div class="openBuyModal shvcdgvcg{{ $element->id }}"
                                style="display: none;width: 100%;">
                                <div role="dialog" tabindex="0"
                                    class="van-popup van-popup--bottom buybox buy{{ $element->id }}"
                                    ...
                                    <div class="listi" data-v-81dae98a="" style="width: 100%;">
                                        <div class="topi" data-v-81dae98a=""><img class="spanimg"
                                            ...
                                            <div class="right" data-v-81dae98a="">
                                                <div class="asteroid" data-v-81dae98a="">
                                                    <p data-v-81dae98a="">{{ $element->name }}</p>
                                                </div>
                                                <div class="incomei" data-v-81dae98a="">
                                                    <div class="leftcome" data-v-81dae98a=""><span
                                                            data-v-81dae98a="">Price:</span>
                                                        <p data-v-81dae98a="">{{ price($element->price) }}</p>
                                                    </div>
                                                </div>
                                                <p class="limtiui" data-v-81dae98a=""> Purchase quantity limit: <span
                                                        data-v-81dae98a="">0</span><strong
                                                        data-v-81dae98a="">/1</strong></p>
                                            </div>
                                        </div>
                                        <p class="line" data-v-81dae98a=""></p>
                                        <p class="looking" data-v-81dae98a="">{{ $element->title }}</p>
                                        <div class="daysi flex" data-v-81dae98a=""><span
                                                data-v-81dae98a="">Cycle:</span>
                                            <p data-v-81dae98a="">{{ $element->validity }} Days</p>
                                        </div>
                                        <div class="daysi flex" data-v-81dae98a=""><span data-v-81dae98a="">Daily
                                                Task:</span>
                                            <p data-v-81dae98a="">{{ $element->task }}</p>
                                        </div>
                                        <div class="daysi flex" data-v-81dae98a=""><span data-v-81dae98a="">Daily
                                        ...
                                        <div class="daysi flex" data-v-81dae98a=""><span data-v-81dae98a="">Total
                                                income:</span>
                                            <p data-v-81dae98a="">
                                                {{ price($task->amount * $element->task * $element->validity) }}</p>
                                        </div>
                                        <div class="accounti flex" data-v-81dae98a="">
                                            <div class="lefti" data-v-81dae98a="">
                                                <p data-v-81dae98a="">{{ price($element->price) }}</p><span
                                                    data-v-81dae98a="">Account assets</span>
                                            </div>

                                        </div>
                                        <button class="invseti limitbtn"
                                            onclick="window.location.href='{{ route('purchase.confirmation', $element->id) }}'"
                                            data-v-81dae98a=""> Invest</button>
                                        <p class="canceli" data-v-81dae98a="" style="background: red;"
                                            onclick="cancelBuyModal('shvcdgvcg{{ $element->id }}', 'buy{{ $element->id }}')">
                                            Cancel</p>
                                    </div><!---->
                                </div>
                            </div>
        ...
        <div class="xuanfu" draggable="true" id="moveDiv">
            <div class="seruis" onclick='window.location.href="https://t.me/ponziscriptshop"'><img class="shake"
                    src="{{ asset('public') }}/IndustrialRobots/dist/img/ic_service.828288ea.png" alt="">
                <p class="un-read">1</p>
            </div>
        </div>
    </div>
